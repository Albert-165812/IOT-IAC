...
<body style="display:flex; flex-direction:column;">
    ...
    <script>
        function sendRequest() {
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    var text = JSON.stringify(xhr.responseText);
                    ...
                    if(response["inside"]["light"] == 1){
                        ...
                        document.getElementById("control_light_livingroom").innerHTML = "OFF";
                    }
                    else{
                        document.getElementById("state_light_livingroom").innerHTML = "OFF";
                        document.getElementById("control_light_livingroom").innerHTML = "ON";
                    }
                    if(response["inside"]["fan"] == 1){
                        document.getElementById("state_fan_livingroom").innerHTML = "ON";
                        document.getElementById("control_fan_livingroom").innerHTML = "OFF";
                    }
                    else{
                        document.getElementById("state_fan_livingroom").innerHTML = "OFF";
                        document.getElementById("control_fan_livingroom").innerHTML = "ON";
                    }
                    if(response["inside"]["curtain"] == 1){
                        document.getElementById("state_curtain_livingroom").innerHTML = "ON";
                        document.getElementById("control_curtain_livingroom").innerHTML = "OFF";
                    }
                    else{
                        document.getElementById("state_curtain_livingroom").innerHTML = "OFF";
                        document.getElementById("control_curtain_livingroom").innerHTML = "ON";
                    }
