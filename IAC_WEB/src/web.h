    ...
    <style>
        ...
        * {
        ...
        #template {
            ...
            display: grid;
            grid-gap: 4px;
            grid-template-rows: var(--row) 1fr var(--row) 1fr var(--row) 1fr;
            grid-template-areas: 
            "row_1 row_1 row_1"
...
<body style="display:flex; flex-direction:column;">
    ...
    <script>
        ...
        var interval = setInterval(sendRequest, 8000);

        document.getElementById("control_light_1").addEventListener("click",()=>{
            (document.getElementById("control_light_1").innerText == "OFF") ?
            control("control/outside/light_1/ON") : control("control/outside/light_1/OFF");
        })
        document.getElementById("control_light_2").addEventListener("click",()=>{
            (document.getElementById("control_light_2").innerText == "OFF") ?
            control("control/outside/light_2/ON") : control("control/outside/light_2/OFF");
        })
        document.getElementById("control_light_livingroom").addEventListener("click",()=>{
            ...
            control("control/livingroom/light/ON") : control("control/livingroom/light/OFF");
        })
        document.getElementById("control_curtain_livingroom").addEventListener("click",()=>{
            ...
            control("control/livingroom/curtain/ON") : control("control/livingroom/curtain/OFF");
        })
        document.getElementById("control_fan_livingroom").addEventListener("click",()=>{
            ...
            control("control/livingroom/fan/ON") : control("control/livingroom/fan/OFF");
        })
        document.getElementById("control_air-conditioner_livingroom").addEventListener("click",()=>{
            (document.getElementById("control_air-conditioner_livingroom").innerText == "OFF") ?
            control("control/livingroom/air_conditioner/ON") : control("control/livingroom/air_conditioner/OFF");
        })
        document.getElementById("control_light_kitchen").addEventListener("click",()=>{
            (document.getElementById("control_light_kitchen").innerText == "OFF") ?
            control("control/kitchen/light/ON") : control("control/kitchen/light/OFF");
        })
        document.getElementById("control_fan_kitchen").addEventListener("click",()=>{
            (document.getElementById("control_fan_kitchen").innerText == "OFF") ?
            control("control/kitchen/fan/ON") : control("control/kitchen/fan/OFF");
        })
        var control = (adrr)=>{
            let URL = window.location
            var xhr = new XMLHttpRequest();
